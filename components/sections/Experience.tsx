...
const experiences = [
  {
    ...
    type: "Full-Time",
    description:
      "Developing and maintaining software solutions for rail transport systems. Designing, coding, testing, and deploying applications that enhance efficiency and safety.",
  ...
  },
  {
    ...
    type: "Part-Time",
    description:
      "Assisted in teaching OOP and Data Structures using Java to over 500 students. Covered fundamental concepts like Abstraction, Encapsulation, and Polymorphism.",
    skills: ["Java"],
  },
  {
    company: "Accenture",
    ...
    type: "Internship",
    description:
      "Full-stack software engineer contributing to web applications. Created user-friendly interfaces and optimized user experiences.",
    skills: [
      "Angular",
      "React",
      "Spring Boot",
  ...
  },
  {
    ...
    type: "Part-Time",
    description:
      "Collaborated with back-end and front-end teams to develop functional web applications and services.",
          ...
          {experiences.map((exp, index) => {
            ...
            return (
              <motion.div
                ...
                className={`group relative border-l-2 pl-8 transition-colors ${
                  isPresent ? "border-primary" : "border-primary/20"
                }`}
              >
                <div
                  className={`absolute -left-[7px] md:-left-[9px] top-[7px] md:top-[9px] h-4 w-4 rounded-full border-2 border-primary ${
                    isPresent ? "bg-primary" : "bg-[var(--background)]"
                  }`}
                />
